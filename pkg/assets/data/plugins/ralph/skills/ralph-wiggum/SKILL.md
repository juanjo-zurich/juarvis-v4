...
El estado del bucle se guarda en `.claude/ralph-loop.local.md` con frontmatter YAML:
...
Elimina el archivo de estado `.claude/ralph-loop.local.md`.
...
1. Comprueba si existe `.claude/ralph-loop.local.md`
